...
const getNewFreeWallet = (): Wallet => {
    ...
    const walletObject: any = { "address": publicKey, "publicKey": publicKey, "privateKey": privateKey, length: publicKey.length }
    return walletObject
}
...
export {
    createTransaction, getPublicFromNodeWallet, createFromWalletTransaction, Wallet,
    getPrivateFromWallet, getBalance, generatePrivateKey, initMasterWallet, deleteWallet, findUnspentTxOuts, getNewFreeWallet
};
